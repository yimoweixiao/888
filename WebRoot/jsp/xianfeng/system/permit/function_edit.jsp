...
<body>
	<div class="easyui-panel" title="功能维护" data-options="footer:'#footer', border: false" fit="true">
		<form id="dataForm" action="<%=basePath%>/action/system/function/doSave.action" method="post" style="padding-top:10px; padding-left:20px;">
...
$(document).ready(function() {
	if (_id != "") {
		...
		$.ajax({
			type: "post",
			url: "<%=basePath%>/action/system/function/doEdit.action?id=<%=id%>",
			async: false,
			cache: false,
