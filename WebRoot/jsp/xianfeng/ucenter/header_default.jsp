...
<body>
	<div class="header1">
		<div class="header2">
			...
			<div id="moduleMenu" style="float:left; padding-top:0px; padding-left:10px; padding-right:10px">
				<a href="javascript:void(0);" class="easyui-linkbutton" data-options="toggle:true, group:'menu', plain:true, iconCls:'icon-add32', size:'large', iconAlign:'top'" style="display:none">一级菜单</a>
			</div>
			<div class="contact" style="float:right; padding-top:10px; padding-right:10px;">
				<div class="prompt">
